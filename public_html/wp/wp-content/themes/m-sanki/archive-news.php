          ...
          <ul class="c-newslist">
            <li class="c-newslist__item">
              <a href="/news/single.html">
                <dl>
                  <dt>
                    <span class="c-newslist__date">2020/11/01</span>
                    <span class="c-label c-label__aaa">企業情報</span>
                  </dt>
                  <dd>お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1お知らせ記事1</dd>
                </dl>
              </a>
            </li>
            <li class="c-newslist__item">
              <a href="/inc/pdf/sample.pdf" target="_blank" rel="noopener">
                <dl>
                  <dt>
                    <span class="c-newslist__date">2020/11/01</span>
                    <span class="c-label c-label__bbb">採用情報</span>
                  </dt>
                  <dd>PDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイルPDFファイル</dd>
                </dl>
              </a>
            </li>
            <li class="c-newslist__item">
              <a href="https://www.google.com/?hl=ja" target="_blank" rel="noopener">
                <dl>
                  <dt>
                    <span class="c-newslist__date">2020/11/01</span>
                    <span class="c-label c-label__ccc">企業情報</span>
                  </dt>
                  <dd>外部ページ</dd>
                </dl>
              </a>
            ...
            <li class="c-newslist__item">
              <a href="/news/single.html">
                <dl>
                  <dt>
                    <span class="c-newslist__date">2020/11/01</span>
                    <span class="c-label c-label__ddd">お知らせ</span>
                  </dt>
                  <dd>お知らせ記事。お知らせ記事。お知らせ記事。お知らせ記事。お知らせ記事。ながーーーーーーーーーーーーーーーーーーーーーーいタイトル</dd>
                </dl>
              </a>
            </li>
          </ul>
