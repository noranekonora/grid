...
<head>
  ...
  <title>PHPパーツ集 | フォノグラム基本パーツ｜grit</title>
  <script src="/inc/js/page/viewport-extra.min.js"></script>
  <script>new ViewportExtra(375);</script>
  <link rel="icon" href="/inc/image/favicon.ico" type="image/x-icon">
  <meta name="description" content="gritの「PHPパーツ集 | フォノグラム基本パーツ」についてのページです。">
  <meta property="og:site_name" content="grit" />
  <meta property="og:title" content="PHPパーツ集 | フォノグラム基本パーツ｜grit" />
  <meta property="og:description" content="gritの「PHPパーツ集 | フォノグラム基本パーツ」についてのページです。" />
  ...
  <link rel="stylesheet" type="text/css" href="/inc/css/page/parts.css">
</head>
        ...
        <div class="l-lowerCaption__inner">
          <div class="l-lowerCaption__titleBox">
            <h1 class="l-lowerCaption__title">
              <small>PHPパーツ集 | フォノグラム基本パーツ</small>
            </h1>
          </div>
          <ul class="c-topicspath">
            <li><a href="/">HOME</a></li>
            <li>PHPパーツ集 | フォノグラム基本パーツ</li>
          </ul>
        </div>
      </div>
      <div id="contents" class="l-lower">
        <div class="l-section">
          <h2 class="u-taC">PHPテスト</h2>
          <ul class="c-list c-list--comment">
            <li class="c-list__item">もし「Failed to decode downloaded font」のような読み込みエラーが出た場合は、「router.php」に使う拡張子の記述がないのが原因と考えられる。</li>
          </ul>
          <?php echo '<p>Hello World</p>'; ?>
          <?php echo '<p>Hello Vader</p>'; ?>
        </div>
      </div>
    </div>
    <!-- end of #main -->
