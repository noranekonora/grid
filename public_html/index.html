        ...
        <div class="p-mainVisual__news">
          <a href="">
            <dl class="p-mainVisual__newsInner">
              <dt>
                <span class="p-mainVisual__newsDate">2022.04.12テストテスト</span>
        ...
        <div class="l-col2 l-col2--side">
          <div class="l-section l-section--full">
            ...
            <div class="l-col2__block">
              <div class="l-col2__img" style="background-image: url('/inc/image/top/pic_youth.jpg');"></div>
              <section class="l-col2__detail">
                <h2 class="c-ttl-2">Jr.Youth</h2>
                <p class="l-col2__catch">「サッカーを楽しみながら、高い技術を習得する」</p>
                <p class="l-col2__txt"> ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。ここに文章が入ります。 </p>
                <div class="l-col2__btn">
                  <a href="/jr-youth/" class="c-link"><span>ジュニアユースについて</span></a>
                </div>
              </section>
            </div>
          </div>
        ...
        <div class="l-section p-news">
          <div class="grid">
            <div class="col-4_sm-12">
              ...
              <a href="/news/" class="c-link u-not-under-sm"><span>お知らせ一覧を見る</span></a>
            </div>
